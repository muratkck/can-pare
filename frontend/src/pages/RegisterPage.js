...
function RegisterPage() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post('https://can-pare-backend.vercel.app/api/users/register', { name, surname, email, password });
  ...
  return (
    <div className='bg-[#f1f5f9] pt-32'>
      <Header />
      <section className="dark:bg-gray-900 min-h-screen" style={{ minHeight: '100vh'}}>
